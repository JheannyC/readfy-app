      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg p-6 space-y-6">
          <div className="border-b border-gray-200 pb-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Upload da Imagem</label>
          ...
          <div>
            ...
            <textarea value={formData.notes} placeholder="Adicione notas sobre o livro..." onChange={(e) => handleInputChange("notes", e.target.value)} rows={4} className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:border-transparent resize-none ${errors.notes ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"}`} />
